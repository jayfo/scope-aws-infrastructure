...
def codebuild_environment_variables_factory(*, context):
    with tasks.terraform.ecr.ecr_read_only(context=context) as ecr:
        return {
            ...
            # "REPOSITORY_TAGS": "v0.3.0 v0.3.0-{}".format(BUILD_TIMESTAMP),
            # "REPOSITORY_TAGS": "v0.4.0 v0.4.0-{}".format(BUILD_TIMESTAMP),
            # "REPOSITORY_TAGS": "v0.5.0 v0.5.0-{}".format(BUILD_TIMESTAMP),
            "REPOSITORY_TAGS": "v0.6.0 v0.6.0-{}".format(BUILD_TIMESTAMP),
        }
